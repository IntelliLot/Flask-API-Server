...
class ParkingData:
    ...
    def create_from_raw_processing(user_id: str, camera_id: str,
                                   ...
                                   gcs_raw_image_path: Optional[str] = None,
                                   gcs_raw_image_url: Optional[str] = None,
                                   gcs_annotated_image_path: Optional[str] = None,
                                   gcs_annotated_image_url: Optional[str] = None,
        ...
        Args:
            ...
            node_id: Node/Device identifier (optional, defaults to camera_id)
            total_slots: Total parking slots
            total_cars_detected: Number of cars detected
            occupied_slots: Number of occupied slots
            empty_slots: Number of empty slots
            occupancy_rate: Occupancy percentage
            slots_details: Detailed slot information
            coordinates: Parking slot coordinates
            image_dimensions: Image width and height
            processing_time_ms: Processing time in milliseconds
            gcs_raw_image_path: Google Cloud Storage path for raw image
            gcs_raw_image_url: Public URL for raw image
            gcs_annotated_image_path: GCS path for annotated image
            gcs_annotated_image_url: Public URL for annotated image
            timestamp: Custom timestamp (optional, defaults to current UTC time)
        ...
        document = {
            ...
            'gcs_storage': {
                'raw_image': {
                    'path': gcs_raw_image_path,
                    'url': gcs_raw_image_url
                } if gcs_raw_image_path else None,
                'annotated_image': {
                    'path': gcs_annotated_image_path,
                    'url': gcs_annotated_image_url
                } if gcs_annotated_image_path else None
            }
        }
